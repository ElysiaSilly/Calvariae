package com.elysiasilly.calvariae.common.block.custom.tyrian;
...
public class TyrianWartBlock extends NetherWartBlock {
    ...
    protected boolean mayPlaceOn(BlockState state, BlockGetter level, BlockPos pos) {
        return state.is(CBlocks.TYRIAN_WART_BLOCK.get()) || state.canSustainPlant(level, pos.below(), Direction.DOWN, state).isTrue();
    }
