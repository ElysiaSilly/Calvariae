...
public class BaseBonemealableMultiFaceBlock extends MultifaceBlock implements BonemealableBlock {

    public final MultifaceSpreader spreader = new MultifaceSpreader(this);
    public static final MapCodec<BaseBonemealableMultiFaceBlock> CODEC = simpleCodec(BaseBonemealableMultiFaceBlock::new);
    public BaseBonemealableMultiFaceBlock(Properties properties) {
        super(properties);
    }
